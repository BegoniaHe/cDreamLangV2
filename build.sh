...
echo ""
echo "使用示例:"
echo "  ./build/dreamlang examples/calculator.zv"
echo "  ./build/dreamlang -l zh_CN examples/calculator.zv"
echo "  ./build/dreamlang -t examples/calculator.zv"
echo "  ./build/dreamlang examples/calculator    # 自动添加 .zv 后缀"
echo ""
echo "获取帮助:"
echo "  ./build/dreamlang --help"
echo "  ./build/dreamlang -l zh_CN --help"
